...
const password_helper_text = document.getElementById('password_helper_text');

// helper array
const helperArray = [username_helper_text, password_helper_text];
...
password.addEventListener('keyup', setStringError, false);